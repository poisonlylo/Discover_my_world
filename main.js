...
startButton.addEventListener( 'click', _Initialize );*/
...
class ThirdPersonCameraDemo {
  ...
  _Initialize() {
   ...
   /////////
    ...
    const texture1 = new THREE.TextureLoader().load('beton1.jpg');
    ...
    const plane = new THREE.Mesh( floor, grass );
    plane.position.set( -100, 0, -300 );
